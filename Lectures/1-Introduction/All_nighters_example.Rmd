...
## \textcolor{cyan}{R Script for the All-nighters Problem}
...
#### \textcolor{cyan}{Step 1: Load the prior and data.}
...
#### \textcolor{cyan}{Step 2: Calculating the likelihood probabilities and posterior probabilities.}
```{r}
...
#### \textcolor{cyan}{Step 3: Present and visualize results.}
```{r}
...
#### \textcolor{cyan}{Remarks}

Note that for values that the prior values do not take on, the prior probability for those values will be zero, and so is the posterior probability.